namespace ReceiptAPI.Producer
{
    public class KafkaProducer
    {
        ...
        // Phương thức để gửi ReceiptMessage
        public async Task ProduceReceiptMessageAsync(string action, Receipt receipt)
        {
            ...
            // Chuyển đổi thành chuỗi JSON
            var messageValue = JsonSerializer.Serialize(receiptMessage);
            await ProduceAsync(receipt.ReceiptId.ToString(), messageValue);
        }
