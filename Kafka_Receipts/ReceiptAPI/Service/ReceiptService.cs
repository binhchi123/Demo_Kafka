namespace ReceiptAPI.Service
{
    public class ReceiptService : IReceiptService
    {
        ...
        public ReceiptService(IReceiptRepository receiptRepository, IIngredientRepository ingredientRepository, 
                              ApplicationDbContext context, KafkaProducer producer)
        {
        ...
        public async Task AddReceiptAsync(ReceiptDTO createReceiptDTO)
        {
            ...
            var receiptMessage = new ReceiptMessage
            {
                Type    = "Add",
                Receipt = receipt
            };
            await _producer.ProduceReceiptMessageAsync("Add", receipt);
        }
        ...
        public async Task DeleteReceiptAsync(int receiptId)
        {
            ...
            await _producer.ProduceReceiptMessageAsync("Delete", existingReceipt);
        }
        ...
        public async Task UpdateReceiptAsync(ReceiptDTO updateReceiptDTO)
        {
            ...
            await _producer.ProduceReceiptMessageAsync("Update", existingReceipt);
        }
