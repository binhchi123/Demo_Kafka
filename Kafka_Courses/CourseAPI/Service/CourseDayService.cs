...
namespace CourseAPI.Service
{
    public class CourseDayService : ICourseDayService
    {
        ...
        public CourseDayService(ICourseDayRepository courseDayRepository, ICourseRepository courseRepository, CourseProducer courseProducer)
        {
        ...
        public async Task AddCourseDayAsync(CourseDayDTO createCourseDayDTO)
        {
            ...
            await _courseProducer.ProduceCourseDayMessageAsync("Add", newCourseDay);
        }
        ...
        public async Task DeleteCourseDayAsync(int courseDayId)
        {
            ...
            {
                Type = "Delete",
                CourseDay = existingCourseDay
            };
            await _courseProducer.ProduceCourseDayMessageAsync("Delete", existingCourseDay);
        }
        ...
        public async Task UpdateCourseDayAsync(CourseDayDTO updateCourseDayDTO)
        {
            ...
            await _courseProducer.ProduceCourseDayMessageAsync("Update", existingCourseDay);
        }
    }
}
